...
public class DungeonGenerator : MonoBehaviour
{
    ...
    private void GenerateMainPath()
    {
        ...
        for (int i = 1; i < roomCount; i++)
        {
            ...
            // √арантированное создание комнаты босса
            ...
            // ≈сли не удалось создать, используем резервный метод
            if (!roomCreated && isBossRoom)
            {
                // —оздаем комнату босса в безопасном направлении
    ...
    private void PlaceLights()
    {
        ...
        // √арантированное освещение дл€ комнаты босса
        if (bossRoom != null)
        {
            for (int i = 0; i < 3; i++)
            {
